...
@Component({
  selector: 'app-homeappliancescategories',
  templateUrl: './homeappliancescategories.component.html',
  styleUrls: ['./homeappliancescategories.component.css']
})
export class HomeappliancescategoriesComponent implements OnInit{
  ...
  ngOnInit(): void {
    ...
    this.homecategoriesService.getHomeAppliancesCategories().subscribe(data => {
      this.cats = data;
    });
    ...
    this.route.params.subscribe(
      data =>{
        this.id = data['id'];
        console.log(this.id);
        this.categoriesService.getCategoryHomeAppliances(this.id).subscribe(
          datax =>{
