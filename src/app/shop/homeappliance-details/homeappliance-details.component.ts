...
@Component({
  selector: 'app-homeappliance-details',
  templateUrl: './homeappliance-details.component.html',
  styleUrls: ['./homeappliance-details.component.css']
})
export class HomeapplianceDetailsComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.route.params.subscribe(
      data =>{
        this.id = data['id'];
        console.log(this.id);
        this.productdetailsService.getHomeApplianceDetails(this.id).subscribe(
          datax =>{
